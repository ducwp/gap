...
add_action('wp', 'gap_check_user_login');
...
add_action('woocommerce_after_add_to_cart_button', 'gap_woocommerce_after_add_to_cart_button');
...
add_filter('the_title', 'gap_shorten_woo_product_title', 10, 2);
...
add_filter('woocommerce_loop_add_to_cart_link', 'gap_woocommerce_loop_add_to_cart_link_filter', 10, 3);
...
add_action('wp_footer', 'gap_page_scrolling');
...
function text_domain_woo_reg_form_fields()
{
  ...
  <p class="form-row">
    <label for="phone"><?php _e('Số điện thoại (có Zalo)', 'text_domain'); ?><span class="required">*</span></label>
    <input type="text" class="input-text" name="phone" id="phone" value="<?php if (!empty($_POST['phone']))
      esc_attr_e($_POST['phone']); ?>" required />
  </p>
  <p class="form-row">
    <label for="name"><?php _e('Tên Zalo', 'text_domain'); ?><span class="required">*</span></label>
    <input type="text" class="input-text" name="name" id="name" value="<?php if (!empty($_POST['name']))
      esc_attr_e($_POST['name']); ?>" required />
  </p>
  <div class="clear"></div>
  <?php
}
