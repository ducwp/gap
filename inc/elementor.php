...
function add_new_translate_form_action($form_actions_registrar)
{

  $form_actions_registrar->register(new CustomFormAction());

}
add_action('elementor_pro/forms/actions/register', 'add_new_translate_form_action');
...
class CustomFormAction extends \ElementorPro\Modules\Forms\Classes\Action_Base
{
  ...
  public function run($record, $ajax_handler)
  {
    ...
    if($luxury_brand === 'yes') $percent = 0.5;
