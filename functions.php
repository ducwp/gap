...
add_action('wp_enqueue_scripts', function () {
  ...
  wp_enqueue_style('gap-flexboxgrid', $theme_uri . '/assets/css/flexboxgrid.css', array('gap'));
  ...
  //
  wp_enqueue_script('gap-script', $theme_uri . '/assets/js/script.js', ['jquery', 'owl-slider'], '', true);
});
