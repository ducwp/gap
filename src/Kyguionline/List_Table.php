...
class List_Table extends \WP_List_Table {
  ...
  public function prepare_items() {
    ...
    $this->form_post_id = Init::instance()->form_id;
  ...
  private function table_data() {
    ...
    foreach ($results as $result) {
      ...
      $link = "<b><a href=admin.php?page=gap-ky-gui-list&fid=%s&ufid=%s>%s</a></b>";
      if (isset($form_value['cfdb7_status']) && ($form_value['cfdb7_status'] === 'read'))
        $link = "<a href=admin.php?page=gap-ky-gui-list&fid=%s&ufid=%s>%s</a>";
